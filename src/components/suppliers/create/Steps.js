                    ...
                    <div className="page-heading__navs">
                        <div className="card-filters-nav">
									<span style={{cursor: "pointer"}}
                                          onClick={this.props.currentStep ? this.props.back : () => history.goBack()}
                                          className="card-filters-nav__item card-filters-nav__back">
										<i className="icon-arrow-left"></i>
									</span>
                            {this.props.next ?
                                <span style={{cursor: "pointer"}} onClick={this.props.next}
                                      className="card-filters-nav__item card-filters-nav__next">
                      <i className="icon-arrow-left"></i>
                    </span> : ''
                            }
                        </div>
                            ...
                            this.props.currentStep >= index ?
                                <div className="supplier-steps-nav__item complete">
                                    <div className="supplier-steps-nav__link">
                                        <i className={icons[index]}></i><span
                                        className="supplier-steps-nav__title">{step}</span>
                                    </div>
                                </div>
                                :
