        ...
        return (
            <>
                <div className={this.props.className}>
                    ...
                    <textarea rows={this.props.rows} cols={this.props.cols} className="box-field__input" id={this.props.name} onChange={this.onChange} value={this.props.value} defaultValue={this.props.defaultValue}></textarea>
                </div>
                {
                    this.props.error ?
