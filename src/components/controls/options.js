                            ...
                            if(this.props.multi){
                                return (
                                    <label className="radio-list__label">
                                        <input disabled={this.props.readOnly} type="checkbox" className="radio-list__check" name={name} value={this.props.value.includes(value)} onChange={(e) => this.onChange(e, value, name)} />
                                ...
                                return (
                                    <label className="radio-list__label">
                                        <input disabled={this.props.readOnly} type="radio" className="radio-list__check" name={this.props.name} value={value} checked={this.props.value === value} defaultValue={this.props.defaultValue} onChange={(e) => this.onChange(e, value)} />
                                        <span className="radio-list__title">{name}</span>
                                    </label>
                                )
                        })
