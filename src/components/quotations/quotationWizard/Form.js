...
const QuotationCreateWizardForm = (props) => (
  <form className="quotation-modal__content -sm" onSubmit={props.handleSubmit}>
      ...
      <div className="quotation-modal__params__row">
        ...
        <div className="quotation-modal__params__item -lg">
          <div className="box-field">
            <label className="box-field__label" htmlFor="quotation_name">Quotation name</label>
            <input type="text" className="box-field__input undefined"
              ...
              name="quotation_name" 
              type="quotation_name" 
              value={props.values.quotation_name} />
          </div>
        </div>
    ...
    { props.createState.loading ? <Loading /> : <div className="btn btn2 btn-save" onClick={props.handleSubmit}>Create</div> }
